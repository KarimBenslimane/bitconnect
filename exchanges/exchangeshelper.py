...
def add_exchange_to_user(password, filename):
    ...
    exchange = str(
        input("Please insert the name of the exchange you want to add.")).lower()
    if is_exchange_valid(exchange):
        ...
        private_key = str(input("Please insert the private key address of " + exchange + "."))
...
def add_exchange(password, filename):
    if add_exchange_to_user(password, filename):
